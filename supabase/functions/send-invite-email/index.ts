const RESEND_API_KEY = Deno.env.get('RESEND_API_KEY') || "re_9jaUmuqb_KSsrYGTYAnZmGcME72MQiC1v";
const SENDER_EMAIL = Deno.env.get('SENDER_EMAIL') || "Constructor App <onboarding@resend.dev>";
