...
import { addInventoryMaterial } from '@/app/actions/materials';
...
const formSchema = z.object({
  ...
  currentStock: z.preprocess(
    (a) => (typeof a === 'string' && a.trim() !== '' ? parseFloat(a) : Number(a)),
...
export default function AddInventoryItemPage() {
  ...
  async function onSubmit(values: z.infer<typeof formSchema>) {
    ...
    try {
      const res = await addInventoryMaterial({
        name: values.name,
      ...
      if (res.success) {
        ...
        toast({
          title: 'Error',
          description: res.error || 'Failed to add inventory item',
          variant: 'destructive',
        });
      }
    } catch (error: any) {
