                    ...
                    <DialogContent className="sm:max-w-[700px] border-muted/30 text-foreground bg-background/95 backdrop-blur-xl max-h-[85vh] overflow-y-auto">
                        {selectedAccount && (
                            <>
                                ...
                                {/* Building Filter inside Dialog */}
                                {projects.length > 0 && (
                                    <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 mt-3 p-3 bg-muted/10 border border-muted/20 rounded-xl">
                                        ...
                                        >
                                            <SelectTrigger className="w-full sm:w-[200px] bg-background/50 border-muted/30 h-8 text-xs">
                                    ...
                                    <TabsContent value="combined" className="space-y-4 mt-4">
                                        <div className="flex justify-between items-center bg-muted/5 border border-muted/15 p-3 rounded-lg">
                                            <div className="text-xs">
                                                ...
                                                <span className="font-bold text-foreground">₹{totalPaidSum.toLocaleString('en-IN')}</span>
                                            </div>
                                            <div className="text-xs">
                                                <span className="text-muted-foreground">Total Outstanding: </span>
                                                <span className="font-bold text-amber-400">₹{totalPendingSum.toLocaleString('en-IN')}</span>
                                            </div>
                                        </div>

                                        <div className="border border-muted/20 rounded-lg overflow-hidden max-h-[350px] overflow-y-auto bg-background/20">
                                            <Table>
                                                <TableHeader className="bg-muted/10">
                                                    <TableRow className="border-muted/20">
                                                        ...
                                                        <TableHead className="text-xs text-right w-[100px]">Status</TableHead>
                                                    </TableRow>
                                                </TableHeader>
                                                <TableBody>
                                                                ...
                                                                {expandedTxId === tx.id && (
                                                                    <TableRow className="bg-muted/10 hover:bg-muted/10 border-none">
                                                                        <TableCell colSpan={5} className="p-3">
                                                                            <div className="bg-background/80 border border-muted/20 rounded-lg p-3.5 space-y-3.5 shadow-inner text-[11px]">
                                                                                <div className="grid grid-cols-2 md:grid-cols-3 gap-3">
                                                                                    <div>
                                                                                        <span className="text-muted-foreground block font-medium uppercase text-[9px] tracking-wider">Building / Site</span>
                                                                                        <span className="font-semibold text-foreground">{tx.project?.name || 'Manual Settlement / Not Linked'}</span>
                                                                                    </div>
                                                                                    <div>
                                                                                ...
                                                                                {tx.notes && (
                                                                                    <div className="border-t border-muted/10 pt-2">
                                                                                        ...
                                                                                        <p className="text-foreground/90 italic mt-0.5">{tx.notes}</p>
                                                                                    </div>
                                                                                )}
                                                                                ...
                                                                                {tx.reference_details && tx.reference_details.startsWith('{') && (() => {
                                                                                    try {
                                                                                        ...
                                                                                        if (parsed.breakdown && parsed.breakdown.length > 0) {
                                                                                            return (
                                                                                                <div className="border-t border-muted/10 pt-2 space-y-1.5">
                                                                                                    <span className="text-muted-foreground block font-medium uppercase text-[9px] tracking-wider mb-1">
                                                                                                        Wages Breakdown ({parsed.breakdown.length} worker categories)
                                                                                                    </span>
                                                                                                    <div className="border border-muted/10 rounded-md overflow-hidden bg-background/50">
                                                                                                        <Table>
                                                                                                            <TableHeader className="bg-muted/15">
                                                                                                                <TableRow className="h-6 border-muted/10">
                                                                                                                    <TableHead className="text-[9px] py-0.5">Worker Category</TableHead>
                                                                                                                    <TableHead className="text-[9px] text-center py-0.5">Man-Days</TableHead>
                                                                                                                    <TableHead className="text-[9px] text-right py-0.5">Daily Rate</TableHead>
                                                                                                                    <TableHead className="text-[9px] text-right py-0.5">Subtotal</TableHead>
                                                                                                                </TableRow>
                                                                                                            </TableHeader>
                                                                                                            <TableBody>
                                                                                                                {parsed.breakdown.map((row: any, i: number) => (
                                                                                                                    <TableRow key={i} className="h-6 border-muted/10 hover:bg-transparent">
                                                                                                                        <TableCell className="py-0.5 text-[10px] font-medium text-foreground/80">{row.category}</TableCell>
                                                                                                                        <TableCell className="py-0.5 text-[10px] text-center text-foreground/80">{row.days}</TableCell>
                                                                                                                        <TableCell className="py-0.5 text-[10px] text-right text-foreground/80">₹{row.rate.toLocaleString('en-IN')}</TableCell>
                                                                                                                        <TableCell className="py-0.5 text-[10px] text-right font-semibold text-foreground/90">₹{row.amount.toLocaleString('en-IN')}</TableCell>
                                                                                                                    </TableRow>
                                                                                                                ))}
                                                                                                            </TableBody>
                                                                                                        </Table>
                                                                                ...
                                                                                {tx.payout_id && (
                                                                                    <div className="flex justify-end border-t border-muted/10 pt-2.5">
                                                                                        <Button
                                                                                            ...
                                                                                            className="bg-muted/40 hover:bg-muted/60 text-[10px] h-7 px-2.5 gap-1"
                                                                                        >
                                    ...
                                    <TabsContent value="rate" className="space-y-4 mt-4">
                                        <div className="grid grid-cols-3 gap-2 text-center p-3 bg-purple-500/5 border border-purple-500/10 rounded-lg text-xs">
                                            <div>
                                                ...
                                                <div className="font-bold text-foreground mt-0.5">₹{rateTotalDueSum.toLocaleString('en-IN')}</div>
                                            </div>
                                            <div>
                                                <div className="text-emerald-400 text-[10px]">TOTAL RECEIVED</div>
                                                <div className="font-bold text-emerald-400 mt-0.5">₹{rateTotalPaidSum.toLocaleString('en-IN')}</div>
                                            </div>
                                            <div>
                                                <div className="text-purple-400 text-[10px]">OUTSTANDING</div>
                                                <div className="font-bold text-purple-400 mt-0.5 font-mono">₹{rateTotalPendingSum.toLocaleString('en-IN')}</div>
                                            </div>
                                        </div>

                                        <div className="border border-muted/20 rounded-lg overflow-hidden max-h-[350px] overflow-y-auto">
                                            <Table>
                                                <TableHeader className="bg-muted/10">
                                                    <TableRow className="border-muted/20">
                                                        <TableHead className="text-xs w-[130px]">Date</TableHead>
                                                                ...
                                                                {expandedTxId === tx.id && (
                                                                    <TableRow className="bg-muted/10 hover:bg-muted/10 border-none">
                                                                        <TableCell colSpan={4} className="p-3">
                                                                            <div className="bg-background/80 border border-muted/20 rounded-lg p-3.5 space-y-3 shadow-inner text-[11px]">
                                                                                <div className="grid grid-cols-2 md:grid-cols-3 gap-3">
                                                                                    <div>
                                                                                        <span className="text-muted-foreground block font-medium uppercase text-[9px] tracking-wider">Building / Site</span>
                                                                                        <span className="font-semibold text-foreground">{tx.project?.name || 'Manual Settlement / Not Linked'}</span>
                                    ...
                                    <TabsContent value="nmr" className="space-y-4 mt-4">
                                        <div className="grid grid-cols-3 gap-2 text-center p-3 bg-teal-500/5 border border-teal-500/10 rounded-lg text-xs">
                                            <div>
                                                ...
                                                <div className="font-bold text-foreground mt-0.5">₹{nmrTotalDueSum.toLocaleString('en-IN')}</div>
                                            </div>
                                            <div>
                                                <div className="text-emerald-400 text-[10px]">TOTAL NMR PAID</div>
                                                <div className="font-bold text-emerald-400 mt-0.5">₹{nmrTotalPaidSum.toLocaleString('en-IN')}</div>
                                            </div>
                                            <div>
                                                <div className="text-teal-400 text-[10px]">OUTSTANDING</div>
                                                <div className="font-bold text-teal-400 mt-0.5 font-mono">₹{nmrTotalPendingSum.toLocaleString('en-IN')}</div>
                                            </div>
                                        </div>
